...
static void print_program_info(int flags, int level)
{
    ...
    av_log(NULL, level, "---------------------------\n");
    av_log(NULL, level, "I call this FlyingVMAF ffmpeg... \n");
    av_log(NULL, level, "A custom ffmpeg version by Zwechon v. 1.00\n");
    av_log(NULL, level, "designed to output VMAF info on the fly\n");
    av_log(NULL, level, "no guarantees on other correct functioning.\n");
    av_log(NULL, level, "----------------------\n");
