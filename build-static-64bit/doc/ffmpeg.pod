...
=item B<-enc_stats_pre[:>I<stream_specifier>B<]> I<path> B<(>I<output,per-stream>B<)>


=item B<-enc_stats_post[:>I<stream_specifier>B<]> I<path> B<(>I<output,per-stream>B<)>

Write per-frame encoding information about the matching streams into the file
given by I<path>.

B<-enc_stats_pre> writes information about raw video or audio frames right
before they are sent for encoding, while B<-enc_stats_post> writes
...
is controlled by B<-enc_stats_pre_fmt> / B<-enc_stats_post_fmt>.
...
=item B<-enc_stats_pre_fmt[:>I<stream_specifier>B<]> I<format_spec> B<(>I<output,per-stream>B<)>


=item B<-enc_stats_post_fmt[:>I<stream_specifier>B<]> I<format_spec> B<(>I<output,per-stream>B<)>

Specify the format for the lines written with B<-enc_stats_pre> /
B<-enc_stats_post>.
...
Encoder timebase, as a rational number I<num/den>. Note that this may be
