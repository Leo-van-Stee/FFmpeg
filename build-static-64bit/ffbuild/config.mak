...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=-D_FORTIFY_SOURCE=0 -D__USE_MINGW_ANSI_STDIO=1 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -DZLIB_CONST
CFLAGS=-mthreads -mtune=generic -O2 -pipe  -Wno-int-conversion -std=c11 -fomit-frame-pointer -IH:/MAABS/local64/include -pthread -IH:/MAABS/msys64/mingw64/include -IH:/MAABS/local64/include -IH:/MAABS/local64/include -IH:/MAABS/local64/include/opus -IH:/MAABS/local64/include/opus -IH:/MAABS/local64/include -IH:/MAABS/local64/include/libvmaf -pthread -IH:/MAABS/msys64/mingw64/include -IH:/MAABS/msys64/mingw64/include -IH:/MAABS/local64/include -IH:/MAABS/local64/include -IH:/MAABS/local64/include -IH:/MAABS/local64/include -IH:/MAABS/local64/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized -IH:/MAABS/local64/include -IH:/MAABS/local64/include/SDL2
CXXFLAGS=-mthreads -mtune=generic -O2 -pipe -fpermissive -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -Wno-int-conversion
NVCCFLAGS=--cuda-gpu-arch=sm_30 -O2 -std=c++11 -m64 -S -nocudalib -nocudainc --cuda-device-only -Wno-c++11-narrowing -include /build/FFmpeg-git/compat/cuda/cuda_runtime.h
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS=-pipe -static-libgcc -static-libstdc++ -L/local64/lib -L/mingw64/lib  -Wl,--nxcompat,--dynamicbase -Wl,--high-entropy-va -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
...
CFLAGS-ffplay=-IH:/MAABS/local64/include -IH:/MAABS/local64/include/SDL2 -Dmain=SDL_main
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lpsapi -lole32 -lstrmiids -luuid -loleaut32 -lshlwapi -lgdi32 -lm -latomic -lvfw32 -LH:/MAABS/local64/lib -lmingw32 -lSDL2main -lSDL2 -Wl,--dynamicbase -Wl,--nxcompat -Wl,--high-entropy-va -lm -ldinput8 -ldxguid -ldxerr8 -luser32 -lgdi32 -lwinmm -limm32 -lole32 -loleaut32 -lshell32 -lsetupapi -lversion -luuid
EXTRALIBS-avfilter=-pthread -lm -latomic -LH:/MAABS/local64/lib -lvmaf -pthread -lm -ldl
EXTRALIBS-swscale=-lm -latomic
EXTRALIBS-postproc=-lm -latomic
EXTRALIBS-avformat=-lm -latomic -lbz2 -lgmp -LH:/MAABS/msys64/mingw64/lib -lz -lsecur32 -lws2_32
EXTRALIBS-avcodec=-LH:/MAABS/local64/lib -lvpx -lm -lm -lpthread -LH:/MAABS/local64/lib -lvpx -lm -lm -lpthread -LH:/MAABS/local64/lib -lvpx -lm -lm -lpthread -LH:/MAABS/local64/lib -lvpx -lm -lm -lpthread -pthread -lm -latomic -llzma -LH:/MAABS/local64/lib -ldav1d -LH:/MAABS/local64/lib -laom -lm -lpthread -lmp3lame -lm -LH:/MAABS/local64/lib -lopus -lm -LH:/MAABS/msys64/mingw64/lib -lvorbis -lm -LH:/MAABS/msys64/mingw64/lib -logg -LH:/MAABS/msys64/mingw64/lib -lvorbisenc -LH:/MAABS/msys64/mingw64/lib -lvorbis -lm -LH:/MAABS/msys64/mingw64/lib -logg -LH:/MAABS/local64/lib -lx264 -lole32 -luser32 -LH:/MAABS/msys64/mingw64/lib -lz -ldl
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-pthread -lm -luser32 -lbcrypt -latomic -ldl
EXTRALIBS-ffplay=-LH:/MAABS/local64/lib -lmingw32 -lSDL2main -lSDL2 -Wl,--dynamicbase -Wl,--nxcompat -Wl,--high-entropy-va -lm -ldinput8 -ldxguid -ldxerr8 -luser32 -lgdi32 -lwinmm -limm32 -lole32 -loleaut32 -lshell32 -lsetupapi -lversion -luuid -lshell32
EXTRALIBS-ffprobe=-lshell32
EXTRALIBS-ffmpeg=-lole32 -lpsapi -lshell32
EXTRALIBS-cpu_init=-pthread
EXTRALIBS-cws2fws=-LH:/MAABS/msys64/mingw64/lib -lz
!ARCH_AARCH64=yes
!ARCH_ALPHA=yes
!ARCH_ARM=yes
!ARCH_AVR32=yes
